...
> **โครงงานระบบบริหารจัดการกระบวนการผลิตสื่อ (Content Production Management System)**  
...
ระบบช่วยจัดการกระบวนการผลิตสื่อตั้งแต่ต้นจนจบ เพื่อให้การทำงานในสตูดิโอมีระเบียบและตรวจสอบได้จริง:
- **Idea**: เสนอและคัดกรองไอเดียคอนเทนต์
- **Production & Tasks**: มอบหมายงานย่อยตามหน้าที่ (บท, ถ่ายทำ, ตัดต่อ) และติดตามความคืบหน้า
- **Review & Revision**: ตรวจสอบผลงานที่ส่งมอบ และส่งกลับแก้ไขพร้อมระบุคำแนะนำ
- **Legal Check**: ตรวจสอบความถูกต้องตามกฎหมายและนโยบาย (ลิขสิทธิ์เพลง, ลิขสิทธิ์ภาพ, PDPA, สปอนเซอร์)
- **Approval & Publish**: อนุมัติและกำหนดการเผยแพร่สื่อ
...
| **👔 Manager (ผู้จัดการทีม)** | Mobile App | อนุมัติไอเดีย, มอบหมายงาน, ตรวจสอบงาน, สั่งแก้ไข, ตรวจสอบสิทธิ์กฎหมาย, และอนุมัติเผยแพร่ |
| **🎨 Member (ทีมงานสร้างสรรค์)** | Mobile App | เสนอไอเดีย, ดูงานที่ได้รับมอบหมาย, อัปเดตสถานะงาน, และแนบลิงก์ส่งมอบผลงานให้ตรวจ |
...
| **2.5** | **Sequence Diagram** | แผนภาพลำดับขั้นตอนการส่งงาน, ตรวจงาน, และตรวจสอบกฎหมาย | [📄 ดูเอกสาร](docs/academic/05-Sequence-Diagrams.md) |
